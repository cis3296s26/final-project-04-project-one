            ...
            <button
              onClick={() => {
                if (roomCodeInput.trim())
                  navigate("/lobby", {
                    state: { roomCode: roomCodeInput.trim() },
                  });
              }}
              className="bg-white px-4 rounded hover:bg-gray-500 transition-all"
            >
              Join
            </button>
          </div>
        ...
        <div className="flex flex-row items-center gap-5">
          ...
          <div className="flex flex-col gap-2">
            <button className="w-7 h-7 flex items-center justify-center cursor-pointer">
              <img
                src={arrow}
                className="w-7 h-7 hover:scale-150 transition-all"
              />
            </button>
            <button className="w-7 h-7 flex items-center justify-center cursor-pointer">
              <img
                src={arrow}
                className="w-7 h-7 hover:scale-150 transition-all rotate-180"
              />
            </button>
          </div>
        </div>
